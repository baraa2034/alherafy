...
class insideCategoriesModle{
  ...
  insideCategoriesModle({this.name,this.image,this.descrption,this.imagedc,this.number,this.imagedctwo});
  insideCategoriesModle.fromMap(Map map){
    ...
    this.imagedctwo=map['imagedctwo'];
